...
[DataContract]
public class InfluenceKind3100 : InfluenceKind
{
    public override void ApplyInfluenceKind(Influence influence, Architecture arch)
    {
        arch.MultipleOfTraining += influence.GetFloatParam() - 1;
    }
    ...
    {
        var frontLineFirst = arch.FrontLine ? influence.GetFloatParam() : 0.01;
